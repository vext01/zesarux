...
#define REALJOYSTICK_EVENT_JOYSELECT 12
#define REALJOYSTICK_EVENT_AUX1 13
#define REALJOYSTICK_EVENT_AUX2 14
#define REALJOYSTICK_EVENT_AUX3 15
#define REALJOYSTICK_EVENT_AUX4 16

//este valor es el numero de ultimo REALJOYSTICK_EVENT_XX +1
#define MAX_EVENTS_JOYSTICK 17
