...
#define REALJOYSTICK_EVENT_NUMBERSELECT 11
#define REALJOYSTICK_EVENT_NUMBERACTION 12
#define REALJOYSTICK_EVENT_JOYSELECT 13
#define REALJOYSTICK_EVENT_AUX1 14
#define REALJOYSTICK_EVENT_AUX2 15
#define REALJOYSTICK_EVENT_AUX3 16
#define REALJOYSTICK_EVENT_AUX4 17

//este valor es el numero de ultimo REALJOYSTICK_EVENT_XX +1
#define MAX_EVENTS_JOYSTICK 18
