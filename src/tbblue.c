	...
	if (value_mask_wr0_wr3==128+2+1) {
		...
		switch (value) {
			...
			case 0x87:
				...
				z80_int transfer_source,transfer_destination;

				if (datagear_wr0 & 4) 	{
					printf ("Port A -> Port B\n");
					transfer_source=value_8_to_16(datagear_port_a_start_addr_high,datagear_port_a_start_addr_low);
					transfer_destination=value_8_to_16(datagear_port_b_start_addr_high,datagear_port_b_start_addr_low);
				}
				else {
