...
void chardetect_printchar(void)
{
	...
	if (chardetect_second_trap_char_dir) {
		if (reg_pc==chardetect_second_trap_char_dir) {
			...
			if (chardetect_second_trap_sum32.v) screen_text_printchar_next(reg_a+32,chardetect_printchar_caracter);
			else screen_text_printchar_next(reg_a,chardetect_printchar_caracter);
