...
./zesarux --noconfigfile --verbose 3 --machine 128k extras/media/spectrum/music.tap --ao $DRIVER
./zesarux --noconfigfile --verbose 3 --machine 128k extras/media/spectrum/beeper/Digi_Pop.tap --ao $DRIVER
...
./zesarux --noconfigfile --verbose 3 --machine 128k --ao $DRIVER
